...
APNGFrame["pack"]      = APNGFrame_pack;    // APNGFrame#pack(source:APNGFrame):Uint8Array
APNGFrame["unpack"]    = APNGFrame_unpack;  // APNGFrame#unpack(source:Uint8Array):APNGFrame
...
function APNGFrame_pack(source) { // @arg APNGFrame
                                  // @ret Uint8Array
    return MessagePack["encode"](source["toJSON"]());
}
function APNGFrame_unpack(source) { // @arg Uint8Array
                                    // @ret APNGFrame
...
function APNGFrame_decode(palette, // @arg Uint32Array - [0xRRGGBBAA, ...]
  ...
  //var unzlibBuffer = WMZLib["inflate"](zlibBuffer, { "verify": true });
    var unzlibBuffer = ZLib["inflate"](zlibBuffer, {});
